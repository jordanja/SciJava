...
public class InfoGramStyle extends Style implements 
	...
	private static final Color bottomPlotOutlineColor = Color.lightGray;
	private static final Color leftPlotOutlineColor = Color.lightGray;
	private static final Color topPlotOutlineColor = Color.lightGray;
	private static final Color rightPlotOutlineColor = Color.lightGray;
	...
	private static final Color[] colorPalette = Palette.InfoGram;
	...
	private static final Color xAxisLinesOnPlotColor = Color.BLACK;
	private static final int xAxisLinesOnPlotWidth = 1;
	
	private static final boolean includeYAxisLinesOnPlot = false;
	private static final Color yAxisLinesOnPlotColor = Color.BLACK;
